...
public class GuilhermeAppl {
    ...
    public GuilhermeAppl() {
        PubSubClient client = new PubSubClient();
        client.startConsole();
    }

    
    public GuilhermeAppl(boolean flag) {
        // Constrói um Client
